...
class DeviceCalendarPlugin() : MethodCallHandler {
    ...
    private fun parseEventArgs(call: MethodCall, calendarId: String?): Event {
        ...
        event.availability = getAvailabilityFromString(call.argument<String>(EVENT_AVAILABILITY_ARGUMENT))
    ...
    private fun getAvailabilityFromString(value: String?): Availability? = when (value) {
