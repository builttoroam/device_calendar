class ErrorMessages {
  ...
  static const String updateAttendeeStatusInvalidArgumentsMessage =
      'Calendar ID, Event ID and/or attendee email argument(s) have not been specified or are invalid';
