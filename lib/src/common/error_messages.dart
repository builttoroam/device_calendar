class ErrorMessages {
  ...
  static const String invalidMissingCalendarId = 'Calendar ID is missing or invalid';
  ...
  static const String createCalendarInvalidCalendarNameMessage = 'Calendar name must not be null or empty';

  static const String invalidRecurrencyFrequency = 'Invalid recurrency frequency';

  static const String unknownDeviceIssue = 'Device calendar plugin ran into an unknown issue';
